...
export default function Bookcar({isDivVisible, setDivVisible,  carType, pickPlace, dropPlace, pickDate, dropDate}){
    ...
    const ReserveCar = async () => {
        ...
        if(!user){
            ...
            try{const {data} = await axios.post('api/reservation',{carType, pickPlace, dropPlace, pickDate, dropDate, pickTime,dropTime ,firstname,lastname ,age ,phone,email,address,city,zipcode})
            //console.log(data)
